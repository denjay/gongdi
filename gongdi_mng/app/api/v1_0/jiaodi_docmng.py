########################################
# create by :cxh-pc
# create time :2018-03-16 11:02:38.286004
########################################
...
def jiaodi_docs_get(page = None,per_page = None,buwei = None,shigong_unit = None,jiaodi_ren = None,bei_jiaodi_ren = None,jwt = None):
