...
def dantis_id_delete(id,jwt = None):
    try:
...
@auth.valid_login
@p.check("danti",["view"])
def company_id_dantis_get(id,page = None,per_page = None,jwt = None):
    datap = Danti.query.\
...
def danti_qrcode_id_get(id,jwt = None):
    try:
